...
const Add = ({ token }) => {
  ...
  //   }
  // };
// Inside Add.jsx - The onSubmitHandler function
const onSubmitHandler = async (e) => {
  e.preventDefault();
  setLoading(true);
  ...
  try {
    ...
    formData.append('category', showCustomCategory && customCategory ? customCategory : mainCategory);
    formData.append('subCategory', tagCategory);
    formData.append('bestseller', bestseller);
    formData.append('discount', discount || 0);
    formData.append('manufacturerDetails', manufacturerDetails);
    formData.append('manufacturerLabel', manufacturerLabel);
    ...
    if (response.data.success) {
      ...
      setImage1(false);
      setImage2(false);
      // ... Reset all other images and states ...
    } else {
      toast.error(response.data.message);
    }
  } catch (error) {
