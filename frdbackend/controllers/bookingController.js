...
// at top of your booking controller file
import sendMail from '../utils/mailer.js'; // <-- Hostinger mailer
...
If you have any questions, please contact us at +91 90880-32004 /01262660027
...
${gym} Team`;
    ...
    const emailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Dear ${booking.name},</p>
        <p>We regret to inform you that your booking for <strong>${booking.facility}</strong> at <strong>${booking.gym}</strong> on <strong>${bookingDate}</strong> (${booking.timeSlot}) has been cancelled.</p>
        <p>If you have any questions or would like to reschedule, please contact us at   +91 90880-32004 /01262660027.</p>
        <br>
        <p>Best regards,<br>${gym} Team</p>
      </div>
    `;
    ...
    try {
      // use central Hostinger mailer
      const info = await sendMail({
        from: `"${gym}" <${process.env.EMAIL_USER}>`,  // e.g. "FRD Gym <support@frdnutritionpremium.com>"
        to: booking.email,
        subject: 'Booking Cancellation Notice',
        text: emailText,
        html: emailHtml,
