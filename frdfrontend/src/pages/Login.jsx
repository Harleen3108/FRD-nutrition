...
const Login = () => {
                ...
                <div>
                  ...
                  >
                      {isLoading ? (
                        ...
                        <span className='text-white'>{currentState === 'Login' ? 'Sign in' : 'Sign up'}</span>
                      )}
                  </button>
                  ...
                  {/* <div className="mt-3">
                    ...
                    >
                      <img src="goog" alt="Google" className="h-5 w-5" onError={(e)=>{e.target.style.display='none'}} />
  ...
  <motion.button
    type="button"
    onClick={handleAuth0Redirect}
    // ⭐ Updated beautiful styling
    className="group relative w-full flex items-center justify-center gap-3 py-3.5 px-4 border-2 border-gray-200 rounded-xl text-slate-700 bg-white font-bold text-sm hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700 transition-all duration-300 shadow-sm hover:shadow-md"
    
    // ⭐ Animation effects
    whileHover={{ scale: 1.02 }}
    whileTap={{ scale: 0.98 }}
  >
    {/* ⭐ FIX: Use the variable name in curly braces, NOT quotes */}
    <img 
      src={googlelogo} 
      alt="Google" 
      className="h-5 w-5" 
